...
${activation_function}Component dim=$hidden_layer_dim
DropoutComponent dim=$hidden_layer_dim dropout-proportion=0.2
AffineComponentPreconditionedOnline input-dim=$hidden_layer_dim output-dim=40 $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
${activation_function}Component dim=40
AffineComponentPreconditionedOnline input-dim=40 output-dim=$hidden_layer_dim $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
${activation_function}Component dim=$hidden_layer_dim
DropoutComponent dim=$hidden_layer_dim dropout-proportion=0.2
