...
cmd=run.pl
num_epochs=10      # Number of epochs during which we reduce
...
hidden_layer_dim=128 #  You may want this larger, e.g. 1024 or 2048.
...
if [ $# != 4 ]; then
  ...
  echo "                                                   # the middle."
  echo "  --activation_function <Tanh|Sigmoid|RectifiedLinear>            # Size of minibatch to process (note: product with --num-threads"  
  exit 1;
fi
...
patch_dim1=8          # dim of convolutional kernel in the first layer
...
hidden_dim=3000	      
  tot_splice=$[($delta_order+1)*($splice_width+1+$splice_width)]
...
Convolutional1dComponent input-dim=$lda_dim output-dim=$conv_out_dim1 learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev patch-dim=$patch_dim1 patch-step=$patch_step1 patch-stride=$feat_dim
...
Convolutional1dComponent input-dim=$pool_out_dim output-dim=$conv_out_dim2 learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev patch-dim=$patch_dim2 patch-step=$patch_step2 patch-stride=$patch_stride2 appended-conv=true
NormalizeComponent dim=$conv_out_dim2
AffineComponentPreconditionedOnline input-dim=$conv_out_dim2 output-dim=$hidden_dim $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
RectifiedLinearComponent dim=$hidden_dim
NormalizeComponent dim=$hidden_dim
AffineComponentPreconditionedOnline input-dim=$hidden_dim output-dim=$hidden_dim $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
RectifiedLinearComponent dim=$hidden_dim
NormalizeComponent dim=$hidden_dim
AffineComponentPreconditionedOnline input-dim=$hidden_dim output-dim=$num_leaves $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=0 bias-stddev=0
