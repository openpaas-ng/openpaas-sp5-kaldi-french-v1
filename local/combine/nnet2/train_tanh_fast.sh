...
splice_width=0 # meaning +- 4 frames on each side for second LDA
...
if [ $# != 5 ]; then
  echo "Usage: $0 [opts] <data> <lang> <ali-dir> <nnet-dir> <exp-dir>"
  echo " e.g.: $0 data/train data/lang exp/tri3_ali exp/nnet2 exp/tri4_nnet"
  echo ""
...
AffineComponentPreconditionedOnline input-dim=$tot_input_dim output-dim=$hidden_layer_dim $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=$stddev bias-stddev=$bias_stddev
